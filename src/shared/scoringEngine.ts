  ...
  return clusters
    .map((cluster) => {
      ...
      return {
        ...
        rationaleDraft:
          `Deterministic Sprint 7.2 scoring ranked this as ${score.priority} from ${signalCountLabel}. Use the factors as review context only; Queue Sentinel is not making an enforcement decision.`,
