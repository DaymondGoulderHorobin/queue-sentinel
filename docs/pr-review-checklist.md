...
- Settings exposes refresh, diagnostics, recent audit entries, fixture pack selection, seed demo, reset demo, ingestion status/preview/seed/reset, and recompute scored incidents controls.
